...
# installed.
TCL_PREFIX='d:/ELEVARE/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='d:/ELEVARE/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='d:/ELEVARE/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Id:/ELEVARE/.conda\Library\include'
...
TCL_PACKAGE_PATH='d:/ELEVARE/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ld:/ELEVARE/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='d:/ELEVARE/.conda\Library\lib\tclstub86.lib'
